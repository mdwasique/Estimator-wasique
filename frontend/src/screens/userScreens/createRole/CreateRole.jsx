...
const CreateRole = () => {
  ...
  const handleCheckboxChange = (e) => {
    ...
    setRoleDetails({ ...roleDetails, [name]: checked });
  };

  const submitHandler = (e) => {
    e.preventDefault();
    console.log("Submitting form:", roleDetails);
          ...
          <div className={styles.form}>
            ...
            <div className={styles.form_container}>
              <form onSubmit={submitHandler}>
                ...
                <div className={styles.form_item}>
                  <div className={styles.icon_span}>
                    <LockOpenTwoToneIcon className={styles.icon} />
                  ...
                  >
                    <label htmlFor="roleTypeOptions">Role Type:</label>
                    <select
                      value={roleDetails.roleTypeOptions}
                      onChange={handleInput}
                      id="roleTypeOptions"
                      name="roleTypeOptions"
                    >
                      <option value="">select type</option>
